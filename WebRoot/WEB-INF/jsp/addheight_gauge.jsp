...
<div class="container">
    <h4>检具-高度规详细信息</h4>
        <form id="form" class="form-inline" action="${pageContext.request.contextPath}/manage/insertHeightGauge.action">     
            ...
            <table class="table table-hover">
              	<tr>
                	...
                	<td><input type="text" class="form-control" name="productSpecification" value=""/></td>
             	 	<td><label for="moldName">检具公差范围</label></td>
                	<td><input type="text" class="form-control"  name="toleranceRange" value=""/></td>               
              	...
              	<tr>
					...
					<td><div class="input-group date form_date"
							...
							<input class="form-control" style="width: 105px" type="text"
								name="declarationDate"> <span class="input-group-addon"><span
                	...
                	<td><input type="text" class="form-control" name="completionDate" value=""/></td> 
                	<td><label for="sideNo">领用人员</label></td>
                	<td><input type="text" class="form-control" name="collarWorkers" value=""/></td>              
    			</tr>
