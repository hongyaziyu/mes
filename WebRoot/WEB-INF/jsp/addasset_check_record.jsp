		...
		$("#addwork")
				.click(
						function() {
							...
							var str;
							str = "<tr><td><input type='text' class='form-control' style='width: 150px;'  name='assetName"+x+"' value='' /></td><td><input type='text'  class='form-control' style='width: 800px;'  name='result"+x+"' value=''  /></td></tr>";
...
<body>
	<form id="form" class="form-inline" action="${pageContext.request.contextPath}/manage/insertAssetCheckRecord.action">
		<div class="container" style="margin-top: 50px;">
			<div class="row">
				<h2 class="col-md-2">添加设备点检项信息</h2>
			</div>
