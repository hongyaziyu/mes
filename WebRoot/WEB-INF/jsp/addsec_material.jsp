...
<div class="container">
    <h4>辅料详细信息</h4>
        <form id="form" class="form-inline" action="${pageContext.request.contextPath}/manage/insertSec.action">     
            <input type="hidden" name="materialsId" value="${sec.materialsId}"/>
            <table class="table table-hover">
              	<tr>
              		<td><label for="sideNo">辅料编号</label></td>
                	<td><input type="text" class="form-control" name="productNo" value=""/></td>  
                	<td><label for="client">辅料名称</label></td>
                	<td><input type="text" class="form-control"  style="width: 250px" name="secMaterialsName" value=""/></td>               
              	 ...
              	 <tr>
                	...
                	<td><input type="text" class="form-control"  style="width: 150px" name="money" value=""/></td>  -->
			 ...
			 <div class="container" style="margin-top: 50px;">
			    	    <h4>存货描述</h4>
			    	    <hr />    
		    	       <textarea class="form-control" style="width: 1110px;" rows="4" name="productDescribe" ></textarea>
