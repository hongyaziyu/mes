...
<body>
	<form class="form-inline"  method="post" name="form1"  action="${pageContext.request.contextPath}/record/approveFullProblem.action">		
	<div class="container">	
	...
	<div class="container" style = "text-align:right">
	  <input class="btn btn-success" type="submit" value="问题已解决">
		<a class="btn btn-primary"  href="${pageContext.request.contextPath}/record/toOutputFullMaterialsRecord.action" >返回</a>
	</div>
</form>		
</body>
</html>
